...
<head>
    ...
    <link href=src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3388.8216546655657!2d35.20294431493236!3d32.223435081131766!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151d6e5c5e9e5f5b%3A0x45c8d8f1a1f2a775!2sAn-Najah%20National%20University!5e0!3m2!1sen!2s!4v1650217316097!5m2!1sen!2s" rel="stylesheet">
            ...
            <div class="row g-0 gx-5 align-items-end justify-content-center">
                <div class="col-lg-6">
                    <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                        <h1 class="mb-3 text-center">Double Dorms</h1>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="property-item rounded overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    <a href=""><img class="img-fluid" src="img/t1.jpg" alt=""></a>
                                </div>
                                <div class="p-4 pb-0">
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="property-item rounded overflow-hidden">
                                ...
                                <div class="p-4 pb-0">
                                    <h5 class="text-primary mb-3">650 &#8362;</h5>
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="property-item rounded overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    <a href=""><img class="img-fluid" src="img/d3.jpg" alt=""></a>

                                </div>
                                <div class="p-4 pb-0">
                                    <h5 class="text-primary mb-3"> 800 &#8362;</h5>
                ...
                <div id="tab-2" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        <div class="col-lg-4 col-md-6">
                            <div class="property-item rounded overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    <a href=""><img class="img-fluid" src="img/t7.jpg" alt=""></a>
                                </div>
                                <div class="p-4 pb-0">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="property-item rounded overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    <a href=""><img class="img-fluid" src="img/d4.jpg" alt=""></a>
                ...
                <div id="tab-3" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        <div class="col-lg-4 col-md-6">
                            <div class="property-item rounded overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    <a href=""><img class="img-fluid" src="img/d5.jpg" alt=""></a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="property-item rounded overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    <a href=""><img class="img-fluid" src="img/dd.jpg" alt=""></a>
                                    <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">For Rent</div>
