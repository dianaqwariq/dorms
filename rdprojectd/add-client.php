...
<div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <form action="register.php" method="post">
                <button id="box" type="button" class="animate__zoomOutUp btn btn-primary btn-lg position-absolute top-0 end-0 mt-9" style="height:110px;" onclick="window.open('register.php', '_blank')">
                    Sign In/Up
                </button>
                </form>
            </div>
