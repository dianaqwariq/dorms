                    ...
                    <div class="tab-pane fade show active" id="agent" role="tabpanel" aria-labelledby="agent-tab">
                        ...
                        <div class="row register-form">
                            <div class="col-md-6">
                                ...
                                <input type="button" class="btnSignIn" value="Sign In" onclick="location.href='index.php';"/>
                        ...
                        <div class="tab-pane fade show" id="student" role="tabpanel" aria-labelledby="student-tab">
                            ...
                            <div class="row register-form">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control" name="txtUserLogin" placeholder="Email " />
                                    </div>

                                    <div class="form-group">
                                        <input type="password" class="form-control"  name="txtUserPass" placeholder="Password " />
                                    </div>


                                        <input type="button" class="btnSignIn" value="Sign In"/>
                                    <p>If you already have an account, sign in else sign up </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade show" id="owner" role="tabpanel" aria-labelledby="owner-tab">
                        ...
                        <div class="row register-form">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control" name="txtUserPass"     placeholder="Email *" value="" />
                                </div>
