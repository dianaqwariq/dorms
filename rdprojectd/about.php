    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                ...
                <div class="col-md-6 animated fadeIn" style="margin-top: 100px">
                    <img class="img-fluid" src="img/about-us.png" style="margin-top: 40px" alt="">
                </div>
            </div>
        </div>
        <!-- Header End -->
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p class="mb-4">Welcome to An-Najah Dorms, the premier housing solution for students at Najah National University. Our mission is to provide safe, comfortable, and affordable living spaces that foster academic success and personal growth.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Locations close to the university</p>
                        <p><i class="fa fa-check text-primary me-3"></i>suitable prices</p>
                        <p><i class="fa fa-check text-primary me-3"></i>multiple options</p>
